...
export declare const DECOMPRESSED_LENGTH = 64;
export declare const PREFIXED_KEY_LENGTH: number;
export declare const PREFIXED_DECOMPRESSED_LENGTH: number;
export declare const MAX_KEY_LENGTH = 1024;
export declare const MAX_MSG_LENGTH = 32;
export declare const EMPTY_BUFFER: Buffer;
export declare const EC_GROUP_ORDER: Buffer;
export declare const ZERO32: Buffer;
export declare const ERROR_BAD_MAC = "Bad MAC";
export declare const ERROR_BAD_PRIVATE_KEY = "Bad private key";
export declare const ERROR_BAD_PUBLIC_KEY = "Bad public key";
export declare const ERROR_EMPTY_MESSAGE = "Message should not be empty";
export declare const ERROR_MESSAGE_TOO_LONG = "Message is too long";
