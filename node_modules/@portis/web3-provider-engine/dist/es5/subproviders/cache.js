...
var createBlockCacheMiddleware = require('@portis/eth-json-rpc-middleware/block-cache');
...
var BlockCacheSubprovider = function (_ProviderSubprovider) {
  ...
  function BlockCacheSubprovider(opts) {
    ...
    return _possibleConstructorReturn(this, (BlockCacheSubprovider.__proto__ || Object.getPrototypeOf(BlockCacheSubprovider)).call(this, function (_ref) {
      var blockTracker = _ref.blockTracker;
      return createBlockCacheMiddleware(Object.assign({ blockTracker: blockTracker }, opts));
    }));
  }
