...
var AuthereumConnector = /*#__PURE__*/function (_AbstractConnector) {
  ...
  _proto.activate = function activate() {
    try {
      ...
      var _temp4 = function () {
        if (!_this3.authereum) {
          return Promise.resolve(new Promise(function (resolve) { resolve(_interopNamespace(require('authereum'))); })).then(function (_ref2) {
...
exports.AuthereumConnector = AuthereumConnector;
//# sourceMappingURL=authereum-connector.cjs.development.js.map
